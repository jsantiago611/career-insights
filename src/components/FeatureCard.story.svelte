	...
	<Hst.Variant title="group usage">
		<section class="mb-16 w-full">
			...
			<div class="flex flex-col gap-6 md:flex-row">
				<FeatureCard title="The Gospel of Matthew" href="/matthew1" stringData="August 2024" />
				<FeatureCard
			...
			<a
				class="mt-8 flex h-6 rounded-sm leading-7 text-gray-600 transition-all dark:text-gray-400 dark:hover:text-gray-200"
				href="/blog"
