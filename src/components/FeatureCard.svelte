...
<a
	class="w-full transform rounded-sm bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 p-1 transition-all hover:scale-[1.01] md:w-1/3"
	{href}
	><div class="flex h-full flex-col justify-between rounded-sm bg-white p-4 dark:bg-gray-900">
